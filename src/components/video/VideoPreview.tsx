                ...
                {convertedVideoPath && (
                    <div className="flex-1 flex flex-col">
                        <div className="flex-1 flex flex-col items-center justify-center mb-6">
                            {thumbnailUrl ? (
                                <div className="relative mb-4 w-64 h-40 mx-auto">
                                    <img 
                                        src={thumbnailUrl} 
                                        alt="Converted video thumbnail" 
                                        className="w-full h-full object-contain rounded-lg shadow-lg bg-gray-100 dark:bg-gray-800"
                                    />
                                ...
                                <div className="w-64 h-40 bg-gray-200 dark:bg-gray-700 rounded-lg flex items-center justify-center mb-4">
